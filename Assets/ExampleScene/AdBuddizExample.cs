...
public class AdBuddizExample : MonoBehaviour {
	...
	{ 
		...
		AdBuddizBinding.SetAndroidPublisherKey("9eadbb57-efee-4305-9e5a-052717b01bff"); // replace with your Android app publisher key
	...
	public void OnGUI()
	{
		...
		if (GUI.Button (new Rect (40, 40, Screen.width - 80, 120), "Show Ad", style) == true) {
			AdBuddizBinding.ShowAd();
		}
		if (GUI.Button (new Rect (40, 240, Screen.width - 80, 120), "Fetch video Ad", style) == true) {
			AdBuddizBinding.RewardedVideo.Fetch();
		}
		if (GUI.Button (new Rect (40, 400, Screen.width - 80, 120), "Show video Ad", style) == true) {
