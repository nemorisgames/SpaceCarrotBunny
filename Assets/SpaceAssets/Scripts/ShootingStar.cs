...
public class ShootingStar : MonoBehaviour {
    ...
    public void Activate(bool activate)
    {
        ...
        if (activated)
        {
            ...
            Vector3 forwardDirection = new Vector3(Camera.main.transform.position.x, Camera.main.transform.position.y, 0f);
            //Force the forwardDirection to don't change the position in the z axis
            forwardDirection = new Vector3(forwardDirection.x, forwardDirection.y, 0f);
